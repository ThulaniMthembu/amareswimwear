...
const customerReviews: CustomerReview[] = [
  { 
    name: "@Ayanda_M", 
    review: "Absolutely in love with this swimsuit! The color pops beautifully on my skin and the fit is perfect for my curves. Can't wait to hit the beach!",
    product: "Pink Sapphire Swimsuit",
    platform: "Instagram"
  },
  { 
    name: "@Lebo_Luxe", 
    review: "This bikini is fire! The design is sleek, and I feel so confident in it. Perfect for those hot Cape Town summer days!",
    product: "Pink Sapphire Bikini",
    platform: "TikTok"
  },
  { 
    name: "@Zama_Stylez", 
    review: "The Maddison swimsuit gives me life! The quality is top-tier, and it hugs my body in all the right places. Got so many compliments at Clifton Beach!",
    product: "Maddison Swimsuit",
    platform: "Instagram"
  },
  { 
    name: "@Thandi_Bae", 
    review: "Obsessed with the Maddison Bikini! It's super comfortable and makes me feel like a goddess. Definitely my new go-to swimwear.",
    product: "Maddison Bikini",
    platform: "TikTok"
  },
  { 
    name: "@Nonhle_G", 
    review: "This bikini is so flattering and stylish! I love how the color pops in all my photos. Summer must-have for sure!",
    product: "Pink Sapphire Bikini",
    platform: "Instagram"
  }
]
...
const featuredProducts = [
  { name: 'Pink Sapphire Swimsuit', price: 650.00, image: '/products/ruby-swimsuit.jpg' },
  { name: 'Pink Sapphire Bikini', price: 600.00, image: '/products/ruby-bikini.jpg' },
  { name: 'Maddison Swimsuit', price: 650.00, image: '/products/maddison-swimsuit.jpg' },
  { name: 'Maddison Bikini', price: 600.00, image: '/products/maddison-bikini.jpg' }
]
...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        await Promise.all(heroContent.map(content => {
    ...
    <div className="flex flex-col min-h-screen bg-[#fafaff]">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-screen w-full overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-[#fafaff] px-4 max-w-4xl mx-auto sm:pb-0 pb-24 mt-[-10vh] flex flex-col h-full justify-center">
                  ...
                  <motion.div
                    ...
                    className="mt-8"
                  >
                    <Button asChild size="lg" className="bg-[#1c1c1c] text-[#fafaff] hover:bg-[#e87167] hover:text-[#1c1c1c] text-lg px-8 py-3">
          ...
          <button
            onClick={() => setCurrentHeroIndex((prevIndex) => (prevIndex - 1 + heroContent.length) % heroContent.length)}
          ...
          <button
            onClick={() => setCurrentHeroIndex((prevIndex) => (prevIndex + 1) % heroContent.length)}
              ...
              {featuredProducts.map((product, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-40 transition-opacity opacity-0 group-hover:opacity-100 flex items-center justify-center">
                    <Button variant="secondary" asChild className="bg-[#fafaff] text-[#1c1c1c] hover:bg-[#e87167]">
                      <Link href="/shop">
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-lg mb-2 text-[#1c1c1c]">{product.name}</h3>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="font-semibold text-[#1c1c1c]">
                    {customerReviews[currentReviewIndex].name} on {customerReviews[currentReviewIndex].platform}
                  </p>
                ...
                {customerReviews.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full ${
                      index === currentReviewIndex ? 'bg-[#1c1c1c]' : 'bg-[#daddd8]'
                    }`}
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                >
                  Amare Swimwear was born from a passion to empower women of all shapes and sizes. Our journey began with a simple idea: every woman deserves to feel confident, beautiful, and comfortable in her swimwear.
                </motion.p>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  We design our swimwear with love, care, and attention to detail, ensuring that each piece not only looks stunning but also provides the perfect fit. Join us in celebrating diversity, body positivity, and self-love.
                </motion.p>
              </div>
              <div>
                <Image
            ...
            >
              <h3 className="text-2xl font-bold mb-4 text-[#1c1c1c]">A Word from Our CEO</h3>
              <p className="text-[#1c1c1c] italic">
                &quot;At Amare, we believe that every woman deserves to feel beautiful and confident in her own skin. Our mission is to create swimwear that not only looks stunning but also empowers women to embrace their unique beauty. We&apos;re committed to celebrating diversity and promoting body positivity through our designs and our community. Join us in this journey of self-love and confidence.&quot;
              </p>
              <p className="mt-4 text-[#1c1c1c] font-semibold">- Zoe Kavinsky, CEO of Amare Swimwear</p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
              ...
              >
                ...
                <p className="text-[#daddd8] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Subscribe to our newsletter for exclusive offers, new arrivals, and swimwear tips.
                </p>
              </motion.div>
              <motion.form
                initial={{ opacity: 0, y: 20 }}
      ...
      <Dialog open={isWelcomeModalOpen} onOpenChange={setIsWelcomeModalOpen}>
        <DialogContent className="bg-[#fafaff]">
          <DialogHeader>
            <DialogTitle className="text-[#1c1c1c]">Welcome to Amare Swimwear!</DialogTitle>
          </DialogHeader>
          <p className="text-[#1c1c1c]">
            Thank you for visiting Amare Swimwear. We&apos;re excited to have you here! Discover our collection of beautiful, comfortable swimwear designed to make you feel confident and empowered.
          </p>
          <Button onClick={() => setIsWelcomeModalOpen(false)} className="bg-[#1c1c1c] text-[#fafaff] hover:bg-[#daddd8] hover:text-[#1c1c1c]">
            Start Exploring
          </Button>
        </DialogContent>
      </Dialog>
